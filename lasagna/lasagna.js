...
/**
* Number of minutes the lasagna should be in oven
*/
...
export function remainingMinutesInOven(actualMinutesInOven) {
  let numberRemainingMinutes = EXPECTED_MINUTES_IN_OVEN - actualMinutesInOven;
  return numberRemainingMinutes;
}
...
export function preparationTimeInMinutes(numberOfLayers) {
  let totalPreparationTime= numberOfLayers * PREPARATION_MINUTES_PER_LAYER;
...
export function totalTimeInMinutes(numberOfLayers, actualMinutesInOven) {
  let totalWorkingTime = preparationTimeInMinutes(numberOfLayers) + actualMinutesInOven;
